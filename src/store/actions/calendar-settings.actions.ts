...
// Fetching user info
export const FETCH_CALENDAR_SETTINGS_INFO = '[Settings] FETCH_CALENDAR_SETTINGS_INFO';
export const FETCH_CALENDAR_SETTINGS_FAIL = '[Settings] FETCH_CALENDAR_SETTINGS_FAIL';
export const FETCH_CALENDAR_SETTINGS_SUCCESS = '[Settings] FETCH_CALENDAR_SETTINGS_SUCCESS';
